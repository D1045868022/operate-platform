...
public class LoanDetailVo {
    private Integer loginId;//外键
    //  联系人信息表 --userrelation
    private String familyContacts; //常用家庭联系人（第一联系人）
    private Integer relationsWithMe; //常用和我的关系（第一联系人）value
    ...
    private Integer amountInstallments;//分期金额
    private Integer paymentCycle;//借款期限 !!!!!!!!!!(还款周期) value
